/* @ts-self-types="./t0_wasm.d.ts" */

export class T0Wasm {
    static __wrap(ptr) {
        const obj = Object.create(T0Wasm.prototype);
        obj.__wbg_ptr = ptr;
        T0WasmFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        T0WasmFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     * row exactly.
     * @param {Float32Array} contexts
     * @param {Uint32Array} lengths
     * @param {number} horizon
     * @returns {Promise<Float32Array>}
     */
    forecastBatchRows(contexts, lengths, horizon) {
        const ptr0 = passArrayF32ToWasm0(contexts, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray32ToWasm0(lengths, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.t0wasm_forecastBatchRows(this.__wbg_ptr, ptr0, len0, ptr1, len1, horizon);
        return ret;
    }
    /**
    ...
    forecast(context, horizon) {
        const ptr0 = passArrayF32ToWasm0(context, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.t0wasm_forecast(this.__wbg_ptr, ptr0, len0, horizon);
        return ret;
    }
    /**
     ...
     */
    gpuBytes() {
        const ret = wasm.t0wasm_gpuBytes(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {T0Wasm}
     */
    static loadF32(safetensors_bytes, config_json) {
        const ptr0 = passArray8ToWasm0(safetensors_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.t0wasm_loadF32(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return T0Wasm.__wrap(ret[0]);
    }
    /**
    ...
    static load(gguf_bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.t0wasm_load(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return T0Wasm.__wrap(ret[0]);
     ...
     */
    nQuantiles() {
        const ret = wasm.t0wasm_nQuantiles(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) T0Wasm.prototype[Symbol.dispose] = T0Wasm.prototype.free;

/**
 * @returns {Promise<void>}
 */
export function initBackend() {
    const ret = wasm.initBackend();
    return ret;
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_6f8b0d724fe26c07: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__hb4bfe5504ef865b6(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_generic_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h27d0c330b83a74d9);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./t0_wasm_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h27d0c330b83a74d9(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h27d0c330b83a74d9(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h156bf3764d385c09(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h156bf3764d385c09(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__hb4bfe5504ef865b6(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__hb4bfe5504ef865b6(arg0, arg1, arg2, arg3);
}


const __wbindgen_enum_GpuPowerPreference = ["low-power", "high-performance"];
const T0WasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_t0wasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('t0_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
